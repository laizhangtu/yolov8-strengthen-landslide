...
model = YOLO('E:\\code\\yolov8\\ultralytics-main\\ultralytics-main\\ultralytics\\cfg\\models\\v8\\yolov8-gold+bif.yaml').load("E:\\code\\yolov8\\ultralytics-main\\runs\detect\\train32\\weights\\best.pt")
